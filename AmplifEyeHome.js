...
//// Protanope Filter Button
$(document).ready(function(){
document.getElementById("protanope").onclick = function() {
    var c = document.getElementById("myCanvas");
    var ctx = c.getContext("2d");
    var img = document.getElementById("photo");
    ctx.drawImage(img, 0, 0);
...
//// Deuteranope Filter Button
$(document).ready(function(){
document.getElementById("deuteranope").onclick = function() {
    var c = document.getElementById("myCanvas");
    var ctx = c.getContext("2d");
    var img = document.getElementById("photo");
    ctx.drawImage(img, 0, 0);
...
//// Tritanope Filter Button
$(document).ready(function(){
document.getElementById("tritanope").onclick = function() {
    var c = document.getElementById("myCanvas");
    var ctx = c.getContext("2d");
    var img = document.getElementById("photo");
    ctx.drawImage(img, 0, 0);
